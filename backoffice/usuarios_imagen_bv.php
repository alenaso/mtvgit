...
// Create page object
$usuarios_imagen_blobview = new cusuarios_imagen_blobview();
$Page =& $usuarios_imagen_blobview;

// Page init
$usuarios_imagen_blobview->Page_Init();

// Page main
$usuarios_imagen_blobview->Page_Main();
?>
<?php
$usuarios_imagen_blobview->Page_Terminate();
?>
<?php
...
// Page class
//
class cusuarios_imagen_blobview {

	// Page ID
	var $PageID = 'blobview';

	// Page object name
	var $PageObjName = 'usuarios_imagen_blobview';
	...
	//
	function cusuarios_imagen_blobview() {
	...
	function Page_Main() {
		...
		$objBinary = new cUpload('usuarios', 'x_imagen');
