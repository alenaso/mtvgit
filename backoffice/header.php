...
var EW_UPLOAD_ALLOWED_FILE_EXT = "gif,jpg,jpeg,png"; // Allowed upload file extension
...
<div class="ewLayout">
 ...
 <?php /* <div class="ewHeaderRow"><img src="phpimages/phpmkrlogo8.png" alt="" border="0"></div> */?>
	<!-- header (end) -->
	<!-- content (begin) -->
