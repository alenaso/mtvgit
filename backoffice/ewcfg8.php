...
define("EW_RANDOM_KEY", 'qvA5vZILotx7zmRl', TRUE); // Random key for encryption
...
if ($_SERVER['SERVER_NAME'] == "www.mtv.com.ar") {
	...
	define("EW_CONN_HOST", 'localhost', TRUE);
	define("EW_CONN_PORT", 3306, TRUE);
	define("EW_CONN_USER", 'mtvqa', TRUE);
	define("EW_CONN_PASS", 'mtvqa.01', TRUE);
	define("EW_CONN_DB", 'mtvqa', TRUE);
} else {
	define("EW_CONN_HOST", 'localhost', TRUE);
	define("EW_CONN_PORT", 3306, TRUE);
	define("EW_CONN_USER", 'root', TRUE);
	define("EW_CONN_PASS", '', TRUE);
	define("EW_CONN_DB", 'mtv_ultimoanio', TRUE);
}
...
define("EW_ADMIN_PASSWORD", "123123", TRUE); // Administrator password
...
// File upload
define("EW_UPLOAD_DEST_PATH", "imagenes/", TRUE); // Upload destination path (relative to app root)
